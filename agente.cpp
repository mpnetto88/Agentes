...
agente::agente() {
    ...
    this->pesoAlinhamento = 0.25;                                //fator de multiplicação do coeficiente de alinhamento
    this->pesoCoesao = 0.1;                                      //fator de multiplicação do coeficiente de coesão
    this->pesoSeparacao = 0.9;                                  //fator de multiplicação do coeficiente de separação
    cleanAlvo();
}
